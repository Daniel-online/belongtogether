  ...
  return (
    <div>
      <Thumb />
        <nav
          id="navbar"
          className="flex items-center justify-between z-50 bg-cover bg-black border-b-2 border-red-600 h-[70px] top-0 w-full px-4 md:px-8 lg:px-16 relative"
        >
          {/* Logo - Mobile: left aligned, Desktop: normal */}
          <div className="place-left flex items-center h-full md:flex-none">
            <Logo />
          </div>
          ...
          {/* Desktop Menu */}
          <div className="hidden md:flex items-center px-px mr-6 flex-1 justify-center">
